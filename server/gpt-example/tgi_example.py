from text_generation_server.models.pb_types import RequestPB, BatchPB, \
...
def handle(args):
    if args.sharded:
        ...
        model = GPTNeox('EleutherAI/gpt-neox-20b', None, quantize=False)
    ...
    batch = model.batch_type.from_pb(request_batch, model.tokenizer, model.device)
    token_count = 1
